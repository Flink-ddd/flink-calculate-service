...
/**
 * @Description 订单统计公共算子
 * @Author muxiaohui
 * @Date 2023/06/30
 * @Version V1.0
 */
public class FlinkOrderService {
    static Logger logger = LoggerFactory.getLogger(FlinkOrderService.class);
